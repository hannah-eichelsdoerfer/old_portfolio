...
`;
const javaScript = `
<svg viewBox="0 0 128 128" id="javaScript">
...
`;
const node = `
<svg viewBox="0 0 128 128" id="node">
...
`;
const ruby = `
<svg viewBox="0 0 128 128" id="ruby">
...
`;
const rails = `
<svg viewBox="0 0 128 128" id="rails">
...
`;
const postgreSQL = `
<svg viewBox="0 0 128 128" id="postgreSQL">
...
`;
const python = `
<svg viewBox="0 0 128 128" id="python">
